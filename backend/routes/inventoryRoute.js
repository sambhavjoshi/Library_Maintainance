...
const { createNewInventory,addToStock,removeFromStock,deleteStock,createStock,getInventory,getStock, updateStock, getAllStocks } = require("../controllers/inventoryController");
