...
const { createSchoolStudent, getAllSchoolStudents, payFeeSchool, getschoolStudent, updateSchoolStudent, deleteSchoolStudent } = require("../controllers/schoolStudentController");
